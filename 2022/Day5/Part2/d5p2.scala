        ...
        for (line <- instruction_lines) {
            ...
            move_from match {
                case 1 => {
                    ...
                    move_to match {
                        case 2 => { stack_two(0) ++= move }
                        case 3 => { stack_three(0) ++= move }
                        case 4 => { stack_four(0) ++= move }
                        case 5 => { stack_five(0) ++= move }
                        case 6 => { stack_six(0) ++= move }
                        case 7 => { stack_seven(0) ++= move }
                        case 8 => { stack_eight(0) ++= move }
                        case 9 => { stack_nine(0) ++= move }
                    }
